...
<div class="container">
    <div class="row">
        ...
        <div class="box animated fadeInDown">
            ...
            <form action="{{ route('forgot-password-confirm', [$user_id, $passwordResetCode]) }}" class="omb_loginForm" autocomplete="off" method="POST">
                {!! Form::token() !!}
                <input type="password" class="form-control email" name="password" placeholder="Nova Senha">
                <span class="help-block">{{ $errors->first('password', ':message') }}</span>
                <input type="password" class="form-control email" name="password_confirm" placeholder="Confirmação da senha">
                <span class="help-block">{{ $errors->first('password_confirm', ':message') }}</span>
                <input type="submit" class="btn btn-block btn-primary" value="Salvar senha"
