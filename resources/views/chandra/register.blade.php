...
<head>
    ...
    <!-- end of global css-->
    <!-- page level styles-->
    <link href="{{ asset('assets/vendors/iCheck/css/minimal/red.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/vendors/iCheck/css/flat/red.css') }}" rel="stylesheet" type="text/css"/>
        ...
        <div class="row " id="form-login">
            ...
            <div class="panel-body social col-sm-offset-3">
                <div class="col-xs-12 col-sm-8 ">
                    ...
                    @endif
                    <br />
                    <form id="regform" class="form-horizontal" method="POST" action="{{ route('admin-register') }}">
                        <!-- CSRF Token -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <div class="input-group input-append  date" id="dpYears" data-date="{!! old('dob') !!}"
                                     data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                    <input class="form-control" type="text" value="{!! old('dob') !!}" name="dob"
                                           id="dob" readonly>
