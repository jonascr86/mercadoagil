                                    ...
                                    <div class="flatbuttons">
                                        ...
                                        <div class="text-left">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <button class="button button-circle button-danger button-large hvr-skew">Button</button>
                                                </li>
                                                <li>
                                ...
                                <div class="panel-body">
                                    <div class="text-left">
                                        ...
                                        <ul class="list-inline">
                                            <li>
                                                <a href="#" class="button button-glow button-rounded button-default hvr-glow">button</a>
                                            </li>
                                            <li>
                                                <a href="#" class="button button-glow button-rounded button-primary hvr-box-shadow-outset">button</a>
                                            </li>
                                            <li>
                                                <a href="#" class="button button-glow button-rounded button-success hvr-box-shadow-inset">button</a>
                                            </li>
                                            <li>
                                                <a href="#" class="button button-glow button-rounded button-info hvr-float-shadow">button</a>
                                            </li>
                                            <li>
                                                <a href="#" class="button button-glow button-rounded button-warning hvr-hover-shadow">button</a>
                                            </li>
                                            <li>
                                                <a href="#" class="button button-glow button-rounded button-danger hvr-shadow-radial">button</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-xs-6 col-sm-6" style="margin-left: 10px">
